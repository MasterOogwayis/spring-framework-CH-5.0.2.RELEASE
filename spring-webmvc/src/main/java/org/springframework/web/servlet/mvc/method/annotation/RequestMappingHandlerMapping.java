...
public class RequestMappingHandlerMapping extends RequestMappingInfoHandlerMapping
    ...
    /**
     * 此类实现了 InitializingBean，当这个bean被创建的时候会调用 afterPropertiesSet() 方法
     * 这个方法也是加载 RequestMappingHandlerMapping 的入口
     *
     * 注解的 @Controller 比继承 AbstractController 复杂
