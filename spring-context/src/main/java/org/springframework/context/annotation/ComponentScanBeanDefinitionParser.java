...
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
    ...
    /**
     * 根据配置的 <context:component-scan base-package="com"/> 解析 base-package
     * 并使用 ClassPathBeanDefinitionScanner 扫描路径下所有class
     *
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        // 获取 <context:component-scan base-package="com"/> 注解的 base-package
        ...
        // 这里扫描后已经将 BeanDefinitions 注册到了 factory
        // 扫描 符合条件的 Bean 并将他们注册到 BeanDefinition
        Set<BeanDefinitionHolder> beanDefinitions = scanner.doScan(basePackages);
        // 这里面要注册非常重要的 注解处理器 比如 AutowiredAnnotationBeanPostProcessor
